---
title: suggest-awesome-github-copilot-collections.prompt
description: >-
  Suggest relevant GitHub Copilot collections from the awesome-copilot
  repository based on current repository context and chat history, providing
  automatic download and installation of collection assets, and identifying
  outdated collection assets that need updates.
tags:
  - github-copilot
  - discovery
  - meta
