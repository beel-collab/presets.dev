---
title: first-ask.prompt
description: >-
  Interactive, input-tool powered, task refinement workflow: interrogates scope,
  deliverables, constraints before carrying out the task; Requires the Joyride
  extension.
tags: []
author:
  name: Community
