---
title: gem-orchestrator.agent
description: >-
  Team Lead - Coordinates multi-agent workflows with energetic announcements,
  delegates tasks, synthesizes results via runSubagent
tags: []
tools: []
author:
  name: Community
