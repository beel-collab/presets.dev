---
title: dotnet-framework.instructions
description: >-
  Guidance for working with .NET Framework projects. Includes project structure,
  C# language version, NuGet management, and best practices.
tags: []
tools: []
author:
  name: Community
