---
title: gem-browser-tester.agent
description: >-
  Automates E2E scenarios with Chrome DevTools MCP, Playwright, Agent Browser.
  UI/UX validation using browser automation tools and visual verification
  techniques
tags: []
tools: []
author:
