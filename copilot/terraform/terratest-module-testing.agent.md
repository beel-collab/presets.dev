---
title: terratest-module-testing.agent
description: >-
  Generate and refactor Go Terratest suites for Terraform modules, including
  CI-safe patterns, staged tests, and negative-path validation.
tags: []
tools:
  - codebase
  - terminalCommand
