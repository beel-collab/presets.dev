---
title: salesforce-aura-lwc.agent
description: >-
  Implement Salesforce UI components using Lightning Web Components and Aura
  components following Lightning framework best practices.
tags: []
tools:
  - codebase
  - edit/editFiles
