---
title: vuejs-expert.agent
description: >-
  Expert Vue.js frontend engineer specializing in Vue 3 Composition API,
  reactivity, state management, testing, and performance with TypeScript
tags: []
tools:
  - changes
  - codebase
