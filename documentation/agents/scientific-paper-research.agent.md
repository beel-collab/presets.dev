---
title: scientific-paper-research.agent
description: >-
  Research agent that searches scientific papers and retrieves structured
  experimental data from full-text studies using the BGPT MCP server.
tags: []
tools:
  - read
  - edit
