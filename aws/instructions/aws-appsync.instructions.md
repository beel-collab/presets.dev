---
title: aws-appsync.instructions
description: >-
  Production-grade guidance for AWS AppSync Event API handlers using APPSYNC_JS
  runtime restrictions, utilities, modules, and datasource patterns
tags: []
tools: []
author:
  name: Community
